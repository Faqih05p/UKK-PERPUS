                                    ...
                                    <div class="card-body">
                                        <?php
                                         if(isset($_POST['login'])) {
                                            ...
                                            echo '<script>alert("Login gagal, Silahkan cek kembali password dan username");</script>';
                                        }
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Login Perpustakaan</div>
                        </div>
                    </div>
                </footer>
            </div>
