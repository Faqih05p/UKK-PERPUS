            ...
            <div class="col-md-12">
                <form method="post">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $query = mysqli_query($koneksi, "INSERT INTO buku(nama_kategori, judul, penulis, penerbit, tahun_terbit) values ('$nama_kategori','$judul','$penulis','$penerbit','$tahun_terbit',)" );
                        ...
                        <div class="col-md-8">
                            <select name="nama_kategori" id="" class="form-select">
                                ...
                                while ($nama_kategori = mysqli_fetch_array($kat)) {
                                   ?> 
                                   <option value="<?php echo $kategori_id['nama_kategori']; ?>"><?php echo $nama_kategori['nama_kategori']; ?></option>
                                    <?php
                                    }
                                ?>
                            </select>    
